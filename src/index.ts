import generate, { lightColorCount } from './generate'

export interface PalettesProps {
  [colorKey: string]: string[] & { primary?: string }
}
...
for (const key of Object.keys(presetPrimaryColors)) {
  presetPalettes[key] = generate(presetPrimaryColors[key])
  presetPalettes[key].primary = presetPalettes[key][lightColorCount]
}
